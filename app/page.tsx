...
export default function Home() {
  ...
  const posts = [
    ...
    "https://www.instagram.com/p/DKFcxrjISnk/",
    "https://www.instagram.com/p/DJ7Ly5TItuA/"
  ]
    ...
    <main>
      <section className="bg-[#d1742c] text-white pt-10 pb-10 md:pb-20 px-6 md:px-12 lg:px-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center">
          <div className="md:w-2/3 z-10">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-8 leading-tight font-title">Bienvenue chez Jim's</h1>
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-[#241f18] h-40 rounded-xl shadow-md">
              <Image
                src={`/images/test.png`}
                alt={`Placeholder ${i}`}
                width={400}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          {[4, 5].map((i) => (
            <div key={i} className="bg-[#241f18] h-64 rounded-xl shadow-md">
              <Image
                src={`/images/test.png`}
                alt={`Placeholder ${i}`}
                width={600}
